...
**Status:** Active backlog. Questions 1–4 are answered by accepted ADRs 0011, 0012, and 0013. No new workshop question is open in this bundle.
...
### 7. How should stale references fail?
...
### 8. Can an object's capabilities change while it is running?
...
### 9. What does one step of game time mean?
...
Questions 1–4 are settled. The next queued topics are questions 5, 6, and 9: object birth, object death, and simulation time. No next question is opened by this document.
